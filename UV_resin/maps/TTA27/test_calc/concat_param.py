...
def main():
    ...
    concat_param = parameter()
    concat_param.read_param("./calc.pram")
    ...
    lmp_data1.import_file('./pack_mol.data', concat_param)
    lmp_data1.export_file(out_dir+"AAAAAAAAAApack_mol.data", concat_param)
    
    concat_param.write_param(out_dir+"AAAAAAAAAAcalc.pram")
    print("finish")
