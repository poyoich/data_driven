...
def main():
    ...
    param3 = parameter()
    param3.read_param("../all_param/pack_mol.params")
    
    concat_param = concat_params(param3, param1)
    ...
    concat_param = concat_params(concat_param, param2)
